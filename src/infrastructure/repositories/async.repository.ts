...
import type { IAsyncRepository } from '../../core/application/contracts/persistence/async-repository.contract';
import type { PrismaService } from '../prisma/prisma.service';

export abstract class AsyncRepository<T, TId> implements IAsyncRepository<T, TId> {
